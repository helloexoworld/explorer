package com.helloexoworld.explorer.config;
...
@Configuration
@EnableMongoRepositories("com.helloexoworld.explorer.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.helloexoworld.explorer.config.dbmigrations");
